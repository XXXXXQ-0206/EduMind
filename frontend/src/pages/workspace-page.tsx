...
import { Clock3, History, ListChecks, SlidersHorizontal } from "lucide-react";
...
import { api, subscribeTaskEvents, type ChatInfo, type ChatMessage, type TaskEvent } from "@/lib/api";
      ...
      if (result.events) {
        ...
        setMessages((items) => [
          ...items,
          {
            id: `a-${Date.now()}`,
            role: "assistant",
            content: stringifyOutput(result),
            meta: "任务已完成",
          },
        ]);
        setBusy(false);
